...
class Controller:
    ...
    def startServer(self):
        ...
        async def connect(sid, environ):
            ...
            if await Toasts.askForPin(title="Controller request",
                ...
                asyncio.create_task(Toasts.rawToast("Your phone has connected to xPalm", "xPalm is ready to receive inputs from your phone."))
        ...
        async def disconnect(sid):
            if sid in self.gamepads_sid:
                ...
                asyncio.create_task(Toasts.rawToast("Your phone has been disconnected from xPalm", "Try reconnecting or double check the internet connection"))
